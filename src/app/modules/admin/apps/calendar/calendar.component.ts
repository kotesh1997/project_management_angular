...
export class CalendarComponent implements OnInit, AfterViewInit, OnDestroy
{
    ...
    onEventClick(calendarEvent): void
    {
        ...
        const event: any = cloneDeep(this.allAppointments.find(item => item.appointmentID === calendarEvent.event._def.extendedProps.appointmentID));
...
statusID: 5
statusName: "Active"
updatedDate: "2021-11-14T00:00:00"
